...
class ViewLocateSchedulePage(BasePage):
    ...
    HeaderTitle = (By.XPATH, "//span[contains(.,'View Tracking Scheduler')]")
    ...
    def validate_edit_link(self):
        return self.isElementDisplayed(self.EditLink)

    def validate_delete_link(self):
    ...
    def validate_DoneBtn(self):
        return self.isElementDisplayed(self.DoneBtn)
