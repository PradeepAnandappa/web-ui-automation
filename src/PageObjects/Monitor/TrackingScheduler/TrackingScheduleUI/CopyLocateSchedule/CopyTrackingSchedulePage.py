...
class CopyTrackingSchedulePage(BasePage):
    CopySchedulerModalTitle = (By.XPATH, "//div[contains(.,'Copy Tracking Scheduler')][@class='popupHeading']")
    ...
    ClosePopup = (By.NAME, "//div[contains(@class,'closePopup')]")
    ...
    EndDateInputbox = (By.XPATH, "(//label[contains(.,'Start Date')]/following-sibling::div/span/span/input)[1]")
    ...
    def validateHeaderTitle(self):
        return self.isElementDisplayed(self.CopySchedulerModalTitle)
