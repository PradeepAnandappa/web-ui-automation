...
class Test_AutomationRules(BaseTest):
    ...
    def test_automationRule(self):
        ...
        expectedMsg = "Are you sure you want to delete this record?"
        assert self.automationRulePage.validate_popupMessage(expectedMsg)
        self.automationRulePage.cancel_deleteAction()
        self.automationRulePage.deleteRuleById(ruleId)
