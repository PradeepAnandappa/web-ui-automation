...
class Test_JobSites(BaseTest):
    ...
    def test_addJobSite(self):
        ...
        self.uploadHubPage.click_DownloadEVVEmployeeData()
        time.sleep(5)
        file_path = str(Path.home()) + "\\PycharmProjects\\allGeo_webApp\\src\\Resources\\Download\\evv_employee-profile.xlsx"
