...
class Test_JobSites(BaseTest):
    ...
    def test_addJobSite(self):
        ...
        time.sleep(2)
        assert self.uploadHubPage.validate_ErrorMessage("We have encountered some errors in the upload file. Kindly check and make corrections.Name can not be blank")
