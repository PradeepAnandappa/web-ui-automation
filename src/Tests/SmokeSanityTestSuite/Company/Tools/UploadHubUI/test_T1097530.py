...
class Test_JobSites(BaseTest):
    ...
    def test_addJobSite(self):
        ...
        time.sleep(2)
        self.uploadHubPage.click_DownloadEarningCodeData()
        time.sleep(5)
        file_path = str(Path.home()) + "\\PycharmProjects\\allGeo_webApp\\src\\Resources\\Download\\earning_codes.xlsx"
