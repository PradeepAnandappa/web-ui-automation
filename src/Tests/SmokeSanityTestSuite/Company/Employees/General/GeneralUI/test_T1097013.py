...
class Test_Company(BaseTest):
    @pytestrail.case('C25617', 'C25618', 'C25619', 'C25621', 'C25622', 'C25626', 'C25628')
    def test_addEmployee(self):
        ...
        time.sleep(1)
        self.editEmployeesPage.setNotificationEmail("testqa@yopmail.com")
        self.editEmployeesPage.click_Save()
        assert "testqa@yopmail.com" == self.editEmployeesPage.getNotificationEmail()
