...
class Test_Company(BaseTest):
    ...
    def test_addEmployee(self):
        ...
        self.employeesPage.accept_termCheckbox()
        self.employeesPage.click_Add()
        assert self.employeesPage.validate_ErrorMessage("already exists in the Account")

        self.employeesPage.click_closeMSG()
        self.employeesPage.click_closeModal()
        time.sleep(2)
