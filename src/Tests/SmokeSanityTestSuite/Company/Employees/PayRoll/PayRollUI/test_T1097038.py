...
class Test_Company(BaseTest):
    ...
    def test_addEmployee(self):
        ...
        time.sleep(2)
        self.editEmployeesPage.enter_Daily_Regular_hours("8")
        self.editEmployeesPage.enter_Daily_Regular_minutes("30")
        self.editEmployeesPage.click_Save()
        time.sleep(10)
        #self.employeesPage.click_edit_for_employee(empPhone)
        #result = self.editEmployeesPage.validate_isActiveRegularPayRollHours("Daily")
        #print(result)
