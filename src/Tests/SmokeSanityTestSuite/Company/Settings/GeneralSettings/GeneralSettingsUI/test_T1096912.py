...
class Test_GeneralSettings(BaseTest):
    ...
    def test_GeneralSettingsUI(self):
        ...
        extracted_timeZone = self.settingsPage.get_timeZone()
        assert timeZone == extracted_timeZone
        self.settingsPage.set_TimeZone(default_timezone)
