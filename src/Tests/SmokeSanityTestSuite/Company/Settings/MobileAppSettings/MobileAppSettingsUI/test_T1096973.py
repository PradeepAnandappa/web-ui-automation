...
class Test_MobileAppSettings(BaseTest):
    ...
    def test_MobileAppSettingsUI(self):
        ...
        self.mobileAppsettingsPage.select_Optin("Optin using App Msg")
        self.mobileAppsettingsPage.validate_selectedOptInValue_inDropdown("Optin using App Msg")
