...
class Test_MobileAppSettings(BaseTest):
    ...
    def test_MobileAppSettingsUI(self):
        ...
        self.mobileAppsettingsPage.select_Optin("Optin using SMS")
        self.mobileAppsettingsPage.validate_selectedOptInValue_inDropdown("Optin using SMS")
