...
class Test_JobSites(BaseTest):
    @pytestrail.case('C25960', 'C25966', 'C25961')
    def test_editJobSites(self):
        ...
        self.editJobSitePage.clearJobSiteName()
        self.editJobSitePage.click_company_icon("Employee")
        assert self.editJobSitePage.validate_popupMessage("The changes are still unsaved. Are you sure you want to leave")
        self.editJobSitePage.dismiss_popup()
        self.editJobSitePage.click_Save()
        assert self.editJobSitePage.validate_FloatingMessage("Name should not be empty")
        editJobsite = "Edit"+siteName
        self.editJobSitePage.editJobSiteName(editJobsite)
        self.editJobSitePage.click_Save()
        time.sleep(2)
        self.jobSitesPage.deleteJobSiteByName(editJobsite)
