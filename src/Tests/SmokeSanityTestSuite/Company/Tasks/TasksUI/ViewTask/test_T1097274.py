...
class Test_Tasks(BaseTest):
    @pytestrail.case('C27818', 'C27819', 'C27820')
    def test_addtask(self):
        ...
        assert self.viewTaskPage.validate_Compnents("Task ID")
        assert self.viewTaskPage.validate_Compnents("Task Name")
        assert self.viewTaskPage.validate_Compnents("Reference ID")
        assert self.viewTaskPage.validate_EditLink()
        assert self.viewTaskPage.validate_DeleteLink()
