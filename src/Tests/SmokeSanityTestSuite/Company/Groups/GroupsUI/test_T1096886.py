...
class Test_Groups(BaseTest):
    @pytestrail.case('C24903', 'C25762', 'C26836')
    def test_GroupsUI(self):
        ...
        self.groupsPage.click_edit_for_GroupId(grp_id)
        self.addEditGroupPage.validate_EditPageHeader()
        time.sleep(5)
        self.addEditGroupPage.assignEmployeeToGroup("9315137976")
        time.sleep(5)
        assert self.addEditGroupPage.validate_assignedEmployeeToGroup("9315137976")
        self.addEditGroupPage.click_Save()
        assert self.addEditGroupPage.validate_SuccessUpdateMessage("successfully")
        ...
        self.addEditGroupPage.validate_EditPageHeader()
        time.sleep(5)
        self.addEditGroupPage.unassignEmployeeFromGroup("9315137976")
        time.sleep(5)
        self.addEditGroupPage.click_Save()
        assert self.addEditGroupPage.validate_SuccessUpdateMessage("successfully")
        time.sleep(2)
