...
class Test_Schedule(BaseTest):
    ...
    def test_ACLPermission(self):
        ...
        time.sleep(1)
        self.editManagersPage.set_ACL_for("Task", "View")
        ...
        self.employeesPage = EmployeesPage(self.driver)
        time.sleep(2)
        flag = self.employeesPage.isAvailable_leftPanelOption("Task")
        ...
        self.leftNavigationPanelPage.click_Company()
        time.sleep(2)
        assert self.employeesPage.isAvailable_leftPanelOption("Task")
