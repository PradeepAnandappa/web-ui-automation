...
class Test_Schedule(BaseTest):
    @pytestrail.case('C29693', 'C29694', 'C29695', 'C29696')
    def test_ACLPermission(self):
        ...
        assert page_found
        assert self.automationRulePage.check_ActionLink_enabled("view", "manual-clock-in")
        assert self.automationRulePage.check_ActionLink_disabled("edit", "manual-clock-in")
        assert self.automationRulePage.check_ActionLink_disabled("delete", "manual-clock-in")
        time.sleep(2)
        self.automationRulePage.logout_user()
        time.sleep(2)
        ...
        time.sleep(2)
        self.editManagersPage.set_ACL_for("Rules", "Edit")
        ...
        time.sleep(2)
        assert self.automationRulePage.check_ActionLink_enabled("view", "manual-clock-in")
        assert self.automationRulePage.check_ActionLink_enabled("edit", "manual-clock-in")
        assert self.automationRulePage.check_ActionLink_disabled("delete", "manual-clock-in")
        self.automationRulePage.logout_user()
        time.sleep(2)
        self.loginPage.user_login(config.AccoundID, config.UserName, config.Password)
        ...
        assert self.editManagersPage.validateHeaderTitle()
        time.sleep(2)
        self.editManagersPage.set_ACL_for("Rules", "Add")
        self.editManagersPage.click_saveBtn()
        time.sleep(2)
        self.editManagersPage.click_Cancel()
        time.sleep(2)
        ...
        assert self.automationRulePage.check_ActionLink_enabled("view", "manual-clock-in")
        assert self.automationRulePage.check_ActionLink_enabled("edit", "manual-clock-in")
        assert self.automationRulePage.check_ActionLink_enabled("delete", "manual-clock-in")
        self.automationRulePage.logout_user()
        self.loginPage.user_login(config.AccoundID, config.UserName, config.Password)
        page_found = self.monitorPage.getPageTitle("Monitor")
        assert page_found
