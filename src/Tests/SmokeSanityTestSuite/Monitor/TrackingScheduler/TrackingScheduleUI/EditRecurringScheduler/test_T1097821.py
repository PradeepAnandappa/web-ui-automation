...
class Test_LocateSchedule(BaseTest):
    ...
    def test_LocateScheduleView(self):
        ...
        self.addEditTrackingSchedulePage.addTrackingSchedule("T103")

        self.trackingSchedulerPage.edit_schedule("T103")
        self.addEditTrackingSchedulePage = AddEditTrackingSchedulePage(self.driver)
        self.addEditTrackingSchedulePage.validate_EditTrackingScheduleModal()
        self.addEditTrackingSchedulePage.editTrackingScheduleStatus()
        self.trackingSchedulerPage.delete_schedule("T103")
