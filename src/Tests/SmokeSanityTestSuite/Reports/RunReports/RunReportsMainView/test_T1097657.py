...
class Test_Report(BaseTest):
    @pytestrail.case('C32815', 'C32822', 'C32823', 'C32825', 'C32826', 'C32827', 'C32828', 'C32830')
    def test_ReportPage(self):
        ...
        time.sleep(2)
        tab_found = self.reportPage.validate_Report_type_tabs("Debug Logs")
        assert tab_found
        self.reportPage.click_report_type_tab("Debug Logs")
        self.debugReportPage = DebugReportPage(self.driver)
        page_found = self.debugReportPage.validate_DebugReportsPage()
        assert page_found
        self.debugReportPage.validate_DebugReportsPage()
